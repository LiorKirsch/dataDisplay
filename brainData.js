...
,{"name":"Hippocampal formation","children" :[
{"name":"Hippocampal region","children" :[
{"name":"Ammon's Horn"}
,{"name":"Dentate gyrus"}]}
,{"name":"Retrohippocampal region","children" :[
{"name":"Subiculum"}]}]}]}]}
,{"name":"Cerebral nuclei","children" :[
{"name":"Striatum","children" :[
{"name":"Striatum dorsal region","children" :[
{"name":"Caudoputamen "}]}
,{"name":"Striatum ventral region","children" :[
{"name":"Nucleus accumbens "}
,{"name":"Fundus of striatum"}
,{"name":"Olfactory tubercle "}]}
,{"name":"Lateral septal complex","children" :[
{"name":"Lateral septal nucleus "}
,{"name":"Septofimbrial nucleus "}]}
,{"name":"Striatum-like amygdalar nuclei","children" :[
{"name":"Central amygdalar nucleus "}
,{"name":"Anterior amygdalar area"}
,{"name":"Medial amygdalar nucleus "}]}]}
,{"name":"Pallidum","children" :[
{"name":"Pallidum_ dorsal region"}
,{"name":"Pallidum_ ventral region","children" :[
{"name":"Magnocellular nucleus"}
,{"name":"Substantia innominata"}]}
,{"name":"Pallidum_ caudal region","children" :[
{"name":"Bed nucleus of the anterior commissure "}
,{"name":"Bed nuclei of the stria terminalis "}]}
,{"name":"Pallidum_ medial region"}]}]}]}
,{"name":"Brain stem","children" :[
{"name":"Interbrain","children" :[
{"name":"Thalamus","children" :[
{"name":"Thalamus_ polymodal association cortex related","children" :[
{"name":"Anterior group of the dorsal thalamus","children" :[
...
,{"name":"Hypothalamic medial zone","children" :[
{"name":"Anterior hypothalamic nucleus"}
,{"name":"Mammillary body","children" :[
...
,{"name":"Hypothalamic lateral zone","children" :[
{"name":"Subthalamic nucleus"}
,{"name":"Tuberal nucleus"}
,{"name":"Zona incerta"}]}]}]}
,{"name":"Midbrain","children" :[
{"name":"Midbrain_ sensory related","children" :[
...
,{"name":"Superior colliculus_ sensory related"}]}
,{"name":"Midbrain_ motor related","children" :[
{"name":"Superior colliculus_ motor related"}
,{"name":"Substantia nigra_ reticular part"}
,{"name":"Ventral tegmental area"}
,{"name":"Midbrain reticular nucleus_ retrorubral area"}
,{"name":"Periaqueductal gray","children" :[
{"name":"Interstitial nucleus of Cajal"}]}
,{"name":"Pretectal region","children" :[
...
,{"name":"Midbrain reticular nucleus_ magnocellular part_ general","children" :[
...
,{"name":"Midbrain_ behavioral state related","children" :[
{"name":"Substantia nigra_ compact part"}
,{"name":"Pedunculopontine nucleus"}
,{"name":"Midbrain raph� nuclei","children" :[
{"name":"Central linear nucleus raph�"}
,{"name":"Dorsal nucleus raph�"}
,{"name":"Interpeduncular nucleus"}]}]}]}
,{"name":"Hindbrain","children" :[
{"name":"Pons","children" :[
{"name":"Pons_ sensory related","children" :[
...
,{"name":"Pons_ motor related","children" :[
...
,{"name":"Pons_ behavioral state related","children" :[
{"name":"Superior central nucleus raph�"}
,{"name":"Locus ceruleus"}
,{"name":"Nucleus incertus"}
,{"name":"Nucleus raph� pontis"}
,{"name":"Subceruleus nucleus"}
,{"name":"Sublaterodorsal nucleus"}]}]}
,{"name":"Medulla","children" :[
{"name":"Medulla_ sensory related","children" :[
{"name":"Area postrema"}
,{"name":"Cochlear nuclei "}
,{"name":"Dorsal column nuclei","children" :[
{"name":"Cuneate nucleus"}
,{"name":"Gracile nucleus"}]}
,{"name":"External cuneate nucleus"}
,{"name":"Nucleus of the solitary tract"}
,{"name":"Spinal nucleus of the trigeminal_ caudal part"}
,{"name":"Spinal nucleus of the trigeminal_ interpolar part"}
,{"name":"Spinal nucleus of the trigeminal_ oral part"}]}
,{"name":"Medulla_ motor related","children" :[
...
,{"name":"Vestibular nuclei","children" :[
{"name":"Lateral vestibular nucleus"}
,{"name":"Medial vestibular nucleus"}]}
,{"name":"Hypoglossal nucleus"}
,{"name":"Nucleus x"}
,{"name":"Nucleus y"}]}
,{"name":"Medulla_ behavioral state related","children" :[
{"name":"Nucleus raph� magnus"}
,{"name":"Nucleus raph� obscurus"}]}]}]}]}
,{"name":"Cerebellum","children" :[
{"name":"Cerebellar nuclei","children" :[
